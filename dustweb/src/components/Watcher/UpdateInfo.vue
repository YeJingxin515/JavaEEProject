    ...
    <div style="display: flex; flex-direction: row; margin-left: 20px">
      <div style="margin-right: 50px">
        ...
        <el-button
          ...
          @click="updateAvatarFormVisible = true"
        >
          <el-avatar
            shape="circle"
            :size="150"
      ...
      <div style="margin-left: 50px">
        <div class="update-title" style="margin-left: 18%; text-align: left">
          修改基本信息
        </div>
        <el-form
        ...
        >
          ...
          <el-form-item label="工作地点" prop="workingStation">
            <el-select
              v-model="UserInfo.workingStation"
              placeholder="请选择工作地点"
              style="width: 420px"
            >
              <el-option
  ...
  methods: {
    submitForm() {
      ...
      localStorage.setItem(
        "workingStation",
        Base64.encode(this.UserInfo.workingStation)
      );
    ...
    resetInfo() {
      this.UserInfo.workingStation = Base64.decode(
        localStorage.getItem("workingStation")
      );
      fetch(
        this.$URL + "/User/GetInformation/Watcher?req=" + this.UserInfo.account,
        {
          method: "GET",
          headers: {
            Authorization:
