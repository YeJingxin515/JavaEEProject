    ...
    <div id="main-box">
      ...
      <div style="display: flex; flex-direction: row; margin-left: 30px; margin-top: 30px">
        ...
        <div class="info-box">
          ...
          <el-row>
            <el-col :span="4"><div class="grid-title">当前车辆</div></el-col>
            <el-col :span="19" :offset="1"><div style="text-align: left">{{UserInfo.Truck}} 垃圾车</div></el-col>
          </el-row>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    ...
    fetch(
      this.$URL + "/User/GetInformation/Carrier?req=" + this.UserInfo.account,
      {
        method: "GET",
        headers: {
          Authorization:
